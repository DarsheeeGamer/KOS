...
class Package:
    ...
    cli_aliases: List[str] = field(default_factory=list)  # Command aliases
    ...
    def from_dict(data: Dict) -> 'Package':
        ...
        pkg.cli_function = data.get("cli_function", "")
        pkg.cli_aliases = data.get("cli_aliases", [])
    ...
    def to_dict(self) -> Dict:
        return {
            ...
            "install_date": self.install_date,  # Already stored as a string in datetime.now().strftime format
